    ...
    <div className="PortfolioContents">
      ...
      <div className="shifted">
        ...
        <p>
          ...
          the pages needed to show it. I chose to do a frontend-only site because
          a backend was unnecessary.
        </p>
        <h3>Design</h3>
        <p>
        ...
        <p>
          ...
          use ChatGPT (4o model) to help with some parts, such as brainstorming
          the best layout for this page and for help with some things I couldn't
          get working.
        </p>
        <h3>Testing</h3>
        <p>
      ...
      <div className="shifted">
        ...
        <p>
          This was also harder than anticipated, but with enough testing, I was
          able to fix the poor responsiveness.
        </p>
      </div>
      ...
      <div className="shifted">
        ...
        <p>
          ...
          about source control. I'm sure there's much more to learn, especially
          when working with others and not just making commits to the main branch.
        </p>
      </div>
      ...
      <div className="shifted">
        ...
        <p>
          ...
          matter much for this project, I will certainly need it for the future.
        </p>
